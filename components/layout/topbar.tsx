...
export function Topbar({
  ...
  return (
    ...
    <header className="relative z-30 flex flex-col gap-4 rounded-[2rem] border border-white/70 bg-white/90 p-5 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.35)] backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between">
